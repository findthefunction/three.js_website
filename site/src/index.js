  ...
  return (
    <>
      <Block factor={1} offset={0}>
        ...
        <Block factor={1.0}>
          <Html className="bottom-left" style={{ color: "yellow" }} position={[-canvasWidth / 2, -canvasHeight / 2, 0]} >
            "A jack of all trades<br /> {mobile ? <br /> : " "}  is a master of none,<br /> but oftentimes better than <br />a master of one."
